...
trace_data = "C:/Users/14777/codeStation/DataProcessing/2x2/trace.txt"
trace_data = LineSentence(trace_data)
# 遍历包含句子的文件：一行 = 一个句子。单词必须已经过预处理并由空格分隔
model = Word2Vec(sentences=trace_data, vector_size=5, sg=1, window=2, min_count=1, workers=4)
